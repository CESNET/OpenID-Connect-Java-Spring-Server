...
public class IsEligibleFilter extends AuthProcFilter {
    ...
    public IsEligibleFilter(AuthProcFilterParams params) {
        super(params);
        this.filterName = params.getFilterName();

        BeanUtil beanUtil = params.getBeanUtil();
        this.config = beanUtil.getBean(PerunOidcConfig.class);
        this.eligibleLastSeenSAMLAttributeName = FiltersUtils.fillStringMandatoryProperty(SAML_ATTRIBUTE, filterName, params);
        this.triggerScope = FiltersUtils.fillStringMandatoryProperty(TRIGGER_SCOPE, filterName, params);
        ...
        this.oldValueHeaderTranslationKey = FiltersUtils.fillStringProperty(
                OLD_VALUE_HEADER_TRANSLATION_KEY, params, DEFAULT_HEADER_TRANSLATION_KEY);
        this.oldValueTextTranslationKey = FiltersUtils.fillStringProperty(
                OLD_VALUE_TEXT_TRANSLATION_KEY, params, DEFAULT_TEXT_TRANSLATION_KEY);
        this.oldValueButtonTranslationKey = FiltersUtils.fillStringProperty(
                OLD_VALUE_BUTTON_TRANSLATION_KEY, params, DEFAULT_BUTTON_TRANSLATION_KEY);
        this.oldValueContactTranslationKey = FiltersUtils.fillStringProperty(
                OLD_VALUE_CONTACT_TRANSLATION_KEY, params, DEFAULT_CONTACT_TRANSLATION_KEY);

        this.noValueHeaderTranslationKey = FiltersUtils.fillStringProperty(
                NO_VALUE_HEADER_TRANSLATION_KEY, params, DEFAULT_HEADER_TRANSLATION_KEY);
        this.noValueTextTranslationKey = FiltersUtils.fillStringProperty(
                NO_VALUE_TEXT_TRANSLATION_KEY, params, DEFAULT_TEXT_TRANSLATION_KEY);
        this.noValueButtonTranslationKey = FiltersUtils.fillStringProperty(
                NO_VALUE_BUTTON_TRANSLATION_KEY, params, DEFAULT_BUTTON_TRANSLATION_KEY);
        this.noValueContactTranslationKey = FiltersUtils.fillStringProperty(
                NO_VALUE_CONTACT_TRANSLATION_KEY, params, DEFAULT_CONTACT_TRANSLATION_KEY);
    ...
    private void redirect(HttpServletRequest req, HttpServletResponse res) {
        ...
        String targetURL = FiltersUtils.buildRequestURL(req, Collections.singletonMap(PARAM_PROMPT, "login"));
